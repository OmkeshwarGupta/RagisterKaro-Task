...
function About() {
  return (
    <div className="flex flex-col md:flex-row relative items-center justify-between w-11/12 mx-auto p-4 pt-16 pb-8 bg-white-100">
      <div className="text-left md:w-1/2">
        <div className="text-[#FFA229] text-xs uppercase tracking-widest pb-4">
          Welcome to RegisterKaro.in
        </div>
        <h2 className="text-4xl font-bold flex pb-4">
          About<div className="text-[#FFA229] pl-1"> Register Karo</div>
        </h2>
        <p className="mt-2 mb-8">{text.description}</p>
        <button className="flex items-center bg-[#1C4670] mb-4 text-white py-2 px-4 rounded-lg shadow-lg hover:bg-gray-600 transition duration-300">
      ...
      <img src={dot} alt=""  className=" absolute bottom-2 -right-12 -z-10 w-32"/>

      <div className=" bg-[#FFA229] w-96 h-[400px] rounded-full absolute -right-[400px] top-0 "></div>
    </div>
  );
}
