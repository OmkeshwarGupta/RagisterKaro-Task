...
const WhySection = () => {
  const cardData = [
    ...
    },
    {
      ...
      svgPath:
        "M39.395 20C39.395 30.7031 30.645 39.375 20.02 39.375C9.31689 39.375 0.64502 30.7031 0.64502 20C0.64502 9.375 9.31689 0.625 20.02 0.625C30.645 0.625 39.395 9.375 39.395 20ZM17.7544 30.3125L32.1294 15.9375C32.5981 15.4688 32.5981 14.6094 32.1294 14.1406L30.3325 12.4219C29.8638 11.875 29.0825 11.875 28.6138 12.4219L16.895 24.1406L11.3481 18.6719C10.8794 18.125 10.0981 18.125 9.62939 18.6719L7.83252 20.3906C7.36377 20.8594 7.36377 21.7188 7.83252 22.1875L15.9575 30.3125C16.4263 30.7812 17.2856 30.7812 17.7544 30.3125Z",
      color: "#3DCD5C",
      bgColor: "#f1fbf3",
    },
    {
  ...
  return (
    <div className="relative w-11/12 mx-auto my-12">
      <div className="md:absolute left-12">
        <div className="text-[#FFA229] text-xs uppercase tracking-widest pb-4">
          Why RegisterKaro.in
        </div>
        <h2 className="text-4xl font-bold flex pb-4">
          Why Choose Register <span className="text-[#FFA229]"> Karo</span>
        </h2>
